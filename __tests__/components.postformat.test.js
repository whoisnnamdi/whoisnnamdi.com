const postFormat = require('../components/postformat').default || require('../components/postformat')
...
describe('postFormat', () => {
  test('formats date and trims excerpt with brackets removed', () => {
    const posts = [{
      ...
      excerpt: '[note] This is a long excerpt that should be trimmed down to a certain number of characters for display in previews.',
    }]
