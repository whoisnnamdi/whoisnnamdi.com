const { decode, parseFromH2Sections, parseFromBookmarks, parseFromEmbeds, parseFromLinks } = require('../lib/talks-parse')
...
describe('talks parsing', () => {
  ...
  test('parseFromBookmarks extracts bookmark cards', () => {
    ...
    expect(items[0]).toMatchObject({ href: 'https://example.com/talk', title: 'Title & More', excerpt: 'Desc', feature_image: '/thumb.jpg' })
  })
