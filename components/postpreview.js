    ...
    return (
        <div className="">
            <Link href="[slug]" as={`/${post.slug}`}>
                <a className="flex flex-col sm:flex-row sm:max-h-80 justify-between rounded-xl shadow-md sm:shadow-none transition duration-500 ease-in-out transform hover:opacity-80 mb-4">
                    <img
