...
- Sync the theme overlay from this repo into a Quartz install: `node scripts/sync-quartz-theme.js /path/to/quartz`
...
The theme overlay files live in `/quartz-theme` and are copied into a clean Quartz install by the sync script.
