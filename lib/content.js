...
/**
 * Get all pages (excludes 'newsletter' and 'portfolio' by default for backwards compatibility)
 */
export async function getAllPages(slugsToExclude = ['newsletter', 'portfolio']) {
...
// Export aliases for backwards compatibility with ghost_data.js
...
export const getAll = getAllContent
